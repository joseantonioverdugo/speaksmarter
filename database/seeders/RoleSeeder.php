...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $role_editor = Role::create(['name' => 'editor']); // va a estar por debajo de admin, pero va a tener acceso al panel de administracion
        ...
        $role_admin->syncPermissions($permissions_admin); // le asigno los permisos al rol admin
        $role_editor->syncPermissions($permissions_editor); // syncPermissions es un metodo de la libreria spatie, que me permite asignarle permisos a un rol
        //$role_editor->givePermissionTo($permission_read_role); // si solo quiero darle un permiso a un rol, uso givePermissionTo
    }
}
